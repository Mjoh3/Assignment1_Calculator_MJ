...
namespace Assignment1_calculator_Martin
{
    class Program
    {
        ...
        static string mess="";
        static double num1=1, num2=1;//to avoid problems the numbers that I will calculate with are not set to 0 by default
        static string oper = "";
        ...
        static void ReadAndEnsure(ref double num)
        {
